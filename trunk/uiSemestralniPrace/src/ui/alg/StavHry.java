                ...
                for (int i = 0; i < sousedniPolicka.size(); i++) {
                    ...
                    while (zkoumaneSousedniPolicko.getBarva() == -1) {
                        ...
                        for (int k = 0; k < kopieListu.size(); k++) {
                            if(kopieListu.get(k).getCisloPolicka() == cisloPoslednihoPolicka) {
                                kopieListu.remove(k);
                                break;
                            }
                        }
...
//                      po cyklu pridani poslednihoStavuHry do listu stavu
    ...
    public int porovnejStavy(Stav<Hra> druhy) {
        ...
        //else return 1;
        int navrat = 1;
        if (druhy.getValue().equals(this.hraciPlocha)) {
            navrat = 0;
        } else if (this.hraciPlocha.equals(druhy.getValue().rotuj(1))) {
            navrat = 0;
        } else if (this.hraciPlocha.equals(druhy.getValue().rotuj(2))) {
            navrat = 0;
        } else if (this.hraciPlocha.equals(druhy.getValue().rotuj(3))) {
            navrat = 0;
        }
        return navrat;
    }
    ...
    public boolean equals(StavHry stav) {
        ...
        if (stav.hraciPlocha.equals(this.hraciPlocha)) {
            navrat = true;
        } else if (this.hraciPlocha.equals(stav.hraciPlocha.rotuj(1))) {
            navrat = true;
        } else if (this.hraciPlocha.equals(stav.hraciPlocha.rotuj(2))) {
            navrat = true;
        } else if (this.hraciPlocha.equals(stav.hraciPlocha.rotuj(3))) {
            navrat = true;
        }
        return navrat;
    }
